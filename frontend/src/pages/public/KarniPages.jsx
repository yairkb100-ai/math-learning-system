...
const KARNI_FAQ = [
  {
    q: 'מה זה מבחן קרני?',
    a: 'מבחן קרני הוא מבחן הקבלה של מכון קרני, שנעשה בו שימוש בקבלה לישיבות תיכוניות ולמוסדות נוספים. הוא מתמקד בחשיבה — מילולית, כמותית, צורנית, לוגית ומרחבית — יחד עם אנגלית ופרק של זריזות ודיוק.',
  },
  {
  ...
  },
  {
    ...
    a: 'בנק השאלות כולל יותר מ-1,000 שאלות בכל תחומי המבחן. הסימולציות מגרילות ממנו שאלות מחדש, כך שאפשר לתרגל שוב ושוב במבחר רחב של שאלות.',
  },
  {
...
export function KarniPage() {
  ...
  return (
    <div className="catalog public-page grade-8 karni-public" dir="rtl">
      <Crumbs trail={KARNI_TRAIL} />
      <PublicHero
        className="pub-hero-karni"
        eyebrow={
          <>
      ...
      <section className="lp-panel">
        <p className="lp-intro">
          <strong>מבחן קרני</strong> הוא מבחן הקבלה של מכון קרני, והוא מתמקד בכישורי חשיבה.
          לכן כדאי להכיר את סוגי השאלות, לפתח שיטת עבודה
          לכל אחד מהם, ולתרגל אותם מספיק פעמים כדי לפתור בביטחון ובקצב ביום המבחן. זה מה שהמסלול הזה
          עושה.
        </p>
      </section>
